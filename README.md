...
| Tests | 519 backend (pytest, moto, real PostgreSQL; 96% coverage), 75 frontend (Vitest, Testing Library) |
...
pytest --cov=app          # 519 tests; AWS is mocked with moto, credentials are fake
ruff check . && mypy
